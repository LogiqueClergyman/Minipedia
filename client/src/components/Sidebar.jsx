...
import { FaCirclePlus, FaBookmark } from "react-icons/fa6";
...
import BarPoll from "./BarPoll.jsx";
const IconSideNav = () => {
  return (
    <div className="bg-slate-900 text-slate-100 flex">
      <SideNav />
      <div className="w-[93%]">
        <div className="h-[10%] mt-1 mx-4 rounded border-2 border-dashed border-slate-600 bg-slate-800 w-full"></div>
        <div className="h-[80%] overflow-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none] m-4 rounded border-2 border-dashed border-slate-600 bg-slate-800 flex flex-wrap">
          <HomeGrid />
          <BarPoll />
        </div>
      </div>
